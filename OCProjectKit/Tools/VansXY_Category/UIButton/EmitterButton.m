...
//  OCProjectKit
//
//  Created by HXB-xiaoYang on 2018/5/11.
...
- (void)setUI {
    ...
    //        粒子速度范围
    explosionCell.velocityRange = 20.00;
...
- (void)startAnimation{
    ...
    [self performSelector:@selector(stopAnimation) withObject:self afterDelay:0.5];
}
