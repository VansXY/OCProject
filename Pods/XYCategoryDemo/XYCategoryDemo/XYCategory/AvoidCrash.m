...
#define kDMBug @"http://340717c7.nat123.cc:39756/DMBug"
//category
...
//                                   @"unifyCode":@"maoxiaodai"
//                                   };
    NSString *string_post = [NSString stringWithFormat:@"errorName=%@&errorReason=%@&errorPlace=%@&exception=%@&unifyCode=maoxiaodai", errorName, errorReason, errorPlace, exception];
    [[PostSessionTask shareHandle] sendMessageWithUrl:kDMBug parameters:string_post];
